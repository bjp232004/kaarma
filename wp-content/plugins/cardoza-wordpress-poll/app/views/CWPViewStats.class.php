        ...
        ?>
            <div class="panel panel-primary" style="margin-top: 15px;">
                <div class="panel-heading">
                    <label><?php _e('Poll Statistics','cardozapolldomain');?></label>
                </div>
                <div class="panel-body">
                    ...
                    if(!empty($votes)){
                        ...
                        ?>
                        <div id="box">
                            <input class="btn btn-sm btn-primary" type="button" onclick="javascript:getPollStatsjs(7)" value="<?php _e('Last 7 days statistics','cardozapolldomain');?>"/>
                            <input class="btn btn-sm btn-primary" type="button" onclick="javascript:getPollStatsjs(15)" value="<?php _e('Last 15 days statistics','cardozapolldomain');?>"/>
                            <input class="btn btn-sm btn-primary" type="button" onclick="javascript:getPollStatsjs(30)" value="<?php _e('Last 30 days statistics','cardozapolldomain');?>"/>
                        </div>
                        <div id="clear"></div>
                        <div id="box">
                            <div id="cwp-graph">
