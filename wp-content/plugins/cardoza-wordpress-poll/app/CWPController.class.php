...
class CWPController {
    ...
    public function getPollLogs(){
        ...
        ?>
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <label>User logs for Poll id #<?php echo $pollid;?></label>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        foreach($logs as $log):
                            if($log->userid > 0):
                                ...
                                ?>
                                <tr style="background-color: #ECF1EF;height:20px;">
                                    <td><?php print $log->userid;?></td>
                                    <td><?php print $userinfo->display_name;?></td>
                                    <td><?php print date('d-m-Y H:i:s', $log->polledtime);?></td>
                                    <td><?php print $log->ip_address;?></td>
                                    <td><?php print $answer;?></td>
                                </tr>
                            <?php endif;
                        endforeach;
                        ?>
        ...
        <?php endif;
        if($available != 'yes') print '<p class="alert alert-danger">'.__('No user logs found for this poll', 'cardozapolldomain').'</p>';
        die();
    }
