...
License: GPL2
*/
define('CWP_POLL_DIR', plugin_dir_url(__FILE__));
...
add_action('wp_head','cwp_poll_ajaxurl');
add_action('admin_head','cwp_poll_ajaxurl');
add_action('plugins_loaded', 'trigger_init');
add_action('wp_footer', 'cwp_poll_custom_css');

register_activation_hook  ( __FILE__, 'CWP_Install' );

/* To include the javascripts */
function cwp_poll_enqueue_scripts()
{
    /* To include the javascripts */
    wp_enqueue_script('jquery');
    wp_enqueue_script('jquery-ui-core');
    wp_enqueue_script('cwp-main', plugins_url('/public/js/cwp-poll.js', __FILE__), array('jquery', 'jquery-ui-core'));
    ...
    wp_enqueue_style('cwp-css', CWP_POLL_DIR.'public/css/cwp-poll.css');
    wp_enqueue_style('cwp-jqui', CWP_POLL_DIR.'public/css/jquery-ui.css');
}
add_action('wp_enqueue_scripts', 'cwp_poll_enqueue_scripts');

function cwp_poll_custom_css(){
	print '<style type="text/css">';
	print get_option('poll_custom_css_code');
	print '</style>';
}

function cwp_poll_ajaxurl() {
...
function trigger_init(){
    ...
    wp_register_sidebar_widget('CWP_WP_POLL', 'Wordpress Poll', 'cwp_poll_widget');
}


function cwp_poll_widget($args){
