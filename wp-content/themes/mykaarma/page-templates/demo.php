	...
	<div class="container">
		<div class="row">
			<div class="right col-md-7 col-sm-6 col-xs-12 pad_left rel_pos">
				<iframe src="//www.youtube.com/embed/oGqLrHldAiU" width="100%" style="max-width:618px;" height="350"></iframe>
			...
			<div class="col-md-5 col-sm-6 form_demo">
				...
				<?php echo do_shortcode('[contact-form-7 id="86" title="Request a Demo"]'); ?>
				<br>
				<br class="hidden-xs">
			</div>
		</div>
